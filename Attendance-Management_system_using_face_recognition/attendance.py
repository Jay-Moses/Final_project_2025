...
bg_image = Image.open("UI_Image/002.png")  # Replace with your image path
bg_image = bg_image.resize((1280, 720), Image.LANCZOS)  # Resize to fit window
...
# Ensure other widgets appear above the background
bg_label.lower()
